...
technology: [Next.js, React.js, Framer Motion, Hubspot, Google Analytics, Tailwind CSS, JavaScript, Axios, Redux.js, Eslint]
# [nextjs.png, reactjs.png, framer-logo.png, hubspot.png, analytics.png, tailwindcss.png, javascript.png, axios.png, redux.png, eslint.png]
---
