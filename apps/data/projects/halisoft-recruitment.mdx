...
technology: [Next.js, Framer Motion, React.js, Tailwind CSS, JavaScript, Axios, GSAP, Redux.js, Eslint]
# [nextjs.png, framer-logo.png, reactjs.png, tailwindcss.png, javascript.png, axios.png, gsap.svg, redux.png, eslint.png]
---
