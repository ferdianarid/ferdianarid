...
projectUrl: https://smeshub.id
author: Ferdian Ahmad R
role: Frontend Engineer
category: Small Medium Enterprise (UMKM)
imageUrl: 'smeshub'
description: SMEsHub is an ecosystem business solution for MSMEs and youth generation that sustainable and ready to face the global competitiveness
createdAt: 'September 22, 2022'
tags: ['Smeshub', 'Business', 'Solution', 'SuperApp']
technology: [Next.js, React.js, Socket.io, Tailwind CSS, TypeScript, Formik, Axios, SWR, SendGrid, Eslint, Midtrans, Google Analytics]
# [nextjs.png, reactjs.png, socketio.png, tailwindcss.png, typescript.png, formik.png, axios.png, swr.png, sendgrid.png, eslint.png, midtrans.jpg, analytics.png]
---
