...
technology: [nextjs.png, reactjs.png, socketio.png, tailwindcss.png, typescript.png, formik.png, axios.png, swr.png, sendgrid.png, eslint.png, midtrans.jpg, analytics.png]
---
