...
id: 4
name: PokeApps
projectUrl: https://pokeapps.vercel.app
category: Landing Page
author: Ferdian Ahmad R
role: Frontend Engineer
imageUrl: 'pokemon'
description: PokeApps has access to a large pool of candidates through our personal database system. Our database provides the foundation for our applicant searches ready to face the global competitiveness
createdAt: 'September 22, 2022'
tags: ['Pokemon', 'Apps', 'Solution', 'Landing Page']
technology: [Vite.js, React.js, Styled Components, JavaScript, Axios, AOS, Eslint]
# [vitejs.png, reactjs.png, styled.png, javascript.png, axios.png, eslint.png]
---
