---
id: 9
name: The Recruit Group
projectUrl: https://therecruitgroup.com.au/
category: Hiring Platform
author: Ferdian Ahmad R
role: Frontend Engineer
imageUrl: 'therecruitgroup'
description: The Recruit Group is a reliable hiring platform that connects top-notch employers with qualified job seekers, providing efficient and effective recruitment solutions
createdAt: 'March, 2023'
tags: ['The Recruit Group', 'Recruitment', 'Talent', 'Australia']
technology: [Vite.js, React.js, Framer Motion, Tailwind CSS, TypeScript, Axios, GSAP, Eslint]
# [vitejs.png, reactjs.png, framer-logo.png, tailwindcss.png, typescript.png, axios.png, gsap.svg, eslint.png]
---

<ContentText>The Recruit Group is a reliable hiring platform that connects top-notch employers with qualified job seekers, providing efficient and effective recruitment solutions</ContentText>
