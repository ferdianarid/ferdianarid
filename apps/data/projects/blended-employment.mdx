...
technology: [Next.js, React.js, Framer Motion, Tailwind CSS, TypeScript, Axios, GSAP, Eslint]
# [nextjs.png, framer-logo.png, reactjs.png, tailwindcss.png, typescript.png, axios.png, gsap.svg, eslint.png]
---
