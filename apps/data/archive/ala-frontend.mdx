...
id: 6
name: ALA Frontend
projectUrl: https://ala-ui-frontend.vercel.app
category: Landing Page
author: Ferdian Ahmad R
role: Freelance Frontend
imageUrl: 'ala-frontend'
description: ALA Frontend has access to a large pool of candidates through our personal database system. Our database provides the foundation for our applicant searches ready to face the global competitiveness
createdAt: 'September 22, 2022'
tags: ['ALA Frontend', 'Apps', 'Solution', 'Landing Page']
---
