...
export const JobStatusBadge: React.FC<any> = ({ children }) => {
    return (
        <span className="text-xs py-1 px-2 text-neutral-10 dark:text-neutral-10 rounded-md bg-blue-500 bg-opacity-100 font-gilroy-bold dark:bg-opacity-50">{children}</span>
    )
}