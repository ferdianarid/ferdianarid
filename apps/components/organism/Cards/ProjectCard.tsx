      ...
      <div className={clsx(
        ...
        <div className="mt-6 flex phone:flex-col gap-2">
          <button onClick={() => openModal()} className={clsx(
            "phone:w-full py-2 rounded-xl px-8 border border-semantic-warning-main dark:border-primary-main text-neutral-10 dark:text-neutral-10 font-gilroy-bold text-sm",
            isLight ? "bg-semantic-warning-main dark:bg-primary-hover" : "bg-primary-main"
          )}>{lang.buttonOpenProject}</button>
          <Link href={`/projects/${projectId}`}>
            <button className={clsx(
              "phone:w-full py-2 rounded-xl px-8 border font-gilroy-bold text-sm",
              isLight ? "" : "bg-neutral-10",
