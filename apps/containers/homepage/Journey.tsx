...
import { fadeLeftAndScaleVariant } from "apps/animations/animationVariant"
    ...
    <div className="w-full bg-neutral-10 overflow-hidden">
      <div className="max-w-[1440px] mx-auto px-6 md:px-24 py-10 md:py-16 flex justify-between flex-col md:flex-row items-center">
        <div className="w-full md:w-1/2">
          <motion.img ref={ref} initial="hidden" animate={controls} variants={fadeLeftAndScaleVariant} src="/images/chair.webp" className="rounded-3xl h-[550px] w-[480px] object-cover" alt="chair" />
        </div>
